...
Future<void> main() async {
  ...
  final String name = 'Gemini Trader 15 Test $randomNum';

  print('--- Testing with Valid Trader ID 15 ---');
  final Map<String, String> bodyParams = {
    'vendor_name': name,
    'vendor_mobile': '98765${randomNum.toString().padLeft(5, '0')}',
    'vendor_email': 'gemini_trader15_$randomNum@test.com',
    'vendor_address': 'Test Address $randomNum',
    'vendor_city': 'City $randomNum',
    'vendor_category': 'Coconut Oil',
    'vendor_trader': '15', // Valid trader ID from adminUser list
    ...
    'vendorProduct_sub_data[0][vendor_product]': 'Test Product $randomNum',
    'vendorProduct_sub_data[0][vendor_product_size]': '10',
    'vendorProduct_sub_data[0][vendor_product_rate]': '500',
    'vendorProduct_sub_data[0][vendor_trader]': '15', // Valid trader ID
